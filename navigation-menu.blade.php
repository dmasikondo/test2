...
@endauth             
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <!-- Settings Dropdown -->
                <div class="ml-12 pl-12 relative xs:ml-12">
                            ...
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                    <img class="h-8 w-8 rounded-full object-cover" @auth src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->profile_photo_url }}" @endauth />
                                       {{--  @auth {{ Auth::user()->first_name[0] }} {{ Auth::user()->second_name[0] }} @endauth --}}                                     
                                </button>
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        {{ Auth::user()->second_name }} {{ Auth::user()->first_name }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                ...
                <div>
                    <div class="font-medium text-base text-gray-800">@auth {{ Auth::user()->second_name }} {{ Auth::user()->first_name }} @endauth</div>
